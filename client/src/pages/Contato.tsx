...
export default function Contato() {
  ...
  // Referência do formulário para o EmailJS
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.sendForm(
        "service_sqyvc0m",         // seu SERVICE ID
        "template_c9occqg",        // seu TEMPLATE ID
        formRef.current!,
        "YtRx1izcx9Ki65byW"        // sua PUBLIC KEY
      );

      // Mensagem automatizada do "agente de IA"
      const response = `Olá ${formData.name}! 👋\n\nObrigado por entrar em contato com a FollowLabs. Recebi sua mensagem: "${formData.message.substring(0, 60)}${formData.message.length > 50 ? "..." : ""}".\n\nNossa equipe irá responder em até 24 horas.`;
              ...
              <div>
                <Card className="border-primary/20">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Preencha o formulário e nosso agente de IA responderá imediatamente.
                    </CardDescription>
                  </CardHeader>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="p-6 rounded-lg bg-primary/5 border border-primary/20">
                          <div className="flex items-start space-x-3 mb-3">
                            ...
                            <div>
                              <p className="font-semibold text-foreground mb-1">Resposta do Agente IA</p>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:contato@followlabs.com.br" className="text-muted-foreground hover:text-primary">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="https://www.linkedin.com/in/followadvisor/" target="_blank" className="text-muted-foreground hover:text-primary">
                          /followlabs
                        </a>
                      </div>
                    </div>
                ...
                <Card className="border-primary/20 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-3">
                      <Bot className="h-6 w-6 text-primary flex-shrink-0 mt-1" />
                      <div>
                        <p className="font-semibold text-foreground mb-2">Atendimento com IA</p>
                        <p className="text-sm text-muted-foreground">
                          Nosso agente de IA fornece resposta imediata. Para assuntos complexos, nossa equipe responde em até 24h.
                        </p>
                      </div>
                    </div>
                  </CardContent>
